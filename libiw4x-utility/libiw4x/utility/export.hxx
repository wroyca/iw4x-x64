...
#if defined(LIBIW4X_UTILITY_STATIC)         // Using static.
#  define LIBIW4X_UTILITY_SYMEXPORT
#elif defined(LIBIW4X_UTILITY_STATIC_BUILD) // Building static.
#  define LIBIW4X_UTILITY_SYMEXPORT
#elif defined(LIBIW4X_UTILITY_SHARED)       // Using shared.
#  ifdef _WIN32
#    define LIBIW4X_UTILITY_SYMEXPORT __declspec(dllimport)
#  else
#    define LIBIW4X_UTILITY_SYMEXPORT
#  endif
#elif defined(LIBIW4X_UTILITY_SHARED_BUILD) // Building shared.
#  ifdef _WIN32
...
//
#  define LIBIW4X_UTILITY_SYMEXPORT         // Using static or shared.
