...
namespace iw4x
{
  ...
  print_usage (::std::ostream& os, ::iw4x::cli::usage_para p)
  {
    ...
    if (p != ::iw4x::cli::usage_para::none)
      os << ::std::endl;

    os << "OPTIONS" << ::std::endl;

    os << std::endl
       << "-v                Print diagnostic." << ::std::endl;

    os << "-V                Print all underlying diagnostic." << ::std::endl;

    os << "--quiet|-q        Run quietly, only printing error messages." << ::std::endl;

    os << "--verbose <level> Set the diagnostics verbosity to <level> between 0 and 3." << ::std::endl;
  ...
  struct _cli_options_map_init
  {
    ...
    {
      _cli_options_map_["-v"] =
      &::iw4x::cli::thunk< options, &options::v_ >;
      _cli_options_map_["-V"] =
      &::iw4x::cli::thunk< options, &options::V_ >;
      _cli_options_map_["--quiet"] =
      &::iw4x::cli::thunk< options, &options::quiet_ >;
      _cli_options_map_["-q"] =
      &::iw4x::cli::thunk< options, &options::quiet_ >;
      _cli_options_map_["--verbose"] =
      &::iw4x::cli::thunk< options, uint16_t, &options::verbose_,
