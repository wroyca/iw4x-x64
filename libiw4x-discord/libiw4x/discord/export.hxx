...
#if defined(LIBIW4X_DISCORD_STATIC)         // Using static.
#  define LIBIW4X_DISCORD_SYMEXPORT
#elif defined(LIBIW4X_DISCORD_STATIC_BUILD) // Building static.
#  define LIBIW4X_DISCORD_SYMEXPORT
#elif defined(LIBIW4X_DISCORD_SHARED)       // Using shared.
#  ifdef _WIN32
#    define LIBIW4X_DISCORD_SYMEXPORT __declspec(dllimport)
#  else
#    define LIBIW4X_DISCORD_SYMEXPORT
#  endif
#elif defined(LIBIW4X_DISCORD_SHARED_BUILD) // Building shared.
#  ifdef _WIN32
...
//
#  define LIBIW4X_DISCORD_SYMEXPORT         // Using static or shared.
