...
#if defined(LIBIW4X_STEAM_STATIC)         // Using static.
#  define LIBIW4X_STEAM_SYMEXPORT
#elif defined(LIBIW4X_STEAM_STATIC_BUILD) // Building static.
#  define LIBIW4X_STEAM_SYMEXPORT
#elif defined(LIBIW4X_STEAM_SHARED)       // Using shared.
#  ifdef _WIN32
#    define LIBIW4X_STEAM_SYMEXPORT __declspec(dllimport)
#  else
#    define LIBIW4X_STEAM_SYMEXPORT
#  endif
#elif defined(LIBIW4X_STEAM_SHARED_BUILD) // Building shared.
#  ifdef _WIN32
...
//
#  define LIBIW4X_STEAM_SYMEXPORT         // Using static or shared.
